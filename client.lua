...
vRPSclothes = Tunnel.getInterface("raid_clothes","raid_clothes")
vRPserver = Tunnel.getInterface("vRP","raid_clothes")
...
function vRPclothes.savePlayerSkin()
	local playerSkin = GetCurrentPed()
	vRPserver.updateCustomization({playerSkin})
end
